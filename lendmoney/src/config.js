...
let ratingABI = [
  ...
  },
  {
    constant: false,
    inputs: [
      { name: "_loaner", type: "address" },
      { name: "_debtor", type: "address" },
      { name: "_amount", type: "uint256" },
      { name: "_interest", type: "uint256" },
      { name: "_duedate", type: "uint256" },
      { name: "_condition", type: "uint256" },
      { name: "loanerprivkey", type: "address" },
      { name: "debtorprivkey", type: "address" }
    ],
    name: "startLoan",
    outputs: [{ name: "", type: "uint256" }],
    payable: true,
  ...
  {
    constant: false,
    inputs: [{ name: "debtorID", type: "uint256" }],
    name: "getDebtor",
  ...
  {
    constant: false,
    inputs: [{ name: "loanerID", type: "uint256" }],
    name: "getLoaner",
    outputs: [{ name: "", type: "address" }],
    payable: false,
    stateMutability: "nonpayable",
    ...
    outputs: [
      {
        components: [
          ...
          { name: "loanFinished", type: "bool" },
          { name: "requestEnd", type: "bool" }
        ],
        name: "",
        type: "tuple[]"
      }
